...
FLANNEL_PULL_COMMAND = 'docker pull quay.io/coreos/flannel:${FLANNEL_VERSION}'
...
FLANNEL_PROCESS = 'pgrep -f \'/opt/bin/flanneld\''
...
if __name__ == '__main__':
    ...
    ctx.logger.info('Starting Flannel on Master')
    ...
    while True:
        ...
        if time.time() > timeout:
            raise NonRecoverableError(
                'Timed out waiting for Flannel to start.'
            )
